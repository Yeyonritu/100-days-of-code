...
data = response.json()
# tday_closing = float(data["Time Series (60min)"]["2024-07-15 19:00:00"]["4. close"])
# yday_closing = float(data["Time Series (60min)"]["2024-07-12 19:00:00"]["4. close"])
...
# else:
#     print("Relax buddy no major changes")
